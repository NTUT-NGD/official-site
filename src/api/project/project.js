...
export function getProject(){
    if(projectObject!=null)
        ...
        console.log("please setProject() first");
}
let project = function(){
    this.new =async function(Manager,datas){
        if(this.collection==null) console.log("please init project");
        else if(datas.Name==null||datas.Intro==null)console.log("at least filled the name and intro");
        else if(!await this.isExists("Users",Manager))console.log("CAN'T find user");
        else{
    ...
    this.addMember = async function(Manager,PID,UID,job){
        ...
        if(!await this.getPermission(Manager)) console.log("dont have permission");
        else if(await this.isExists("Projects",PID)&& await this.isExists("Users",UID)){
            await projectCol
                .doc(PID)
                .get()
                .then( function(docRef){
                    ...
                    if(!parties.find(function(value,index){
                        if(value.UID==UID){
